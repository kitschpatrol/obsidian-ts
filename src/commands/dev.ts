 ...
 * @param options.level - Filter by log level: `log`, `warn`, `error`, `info`,
 *   or `debug`.
 *
 ...
 *
 * @param options - Command options.
 * @param options.enable - `true` to enable, `false` to disable mobile
 *   emulation.
 *
 * @returns Status message.
 * @throws {ObsidianError} If the CLI returns an error.
 ...
 *
 * @param options - Command options.
 * @param options.code - JavaScript code to execute (has access to the `app`
 *   context).
 *
